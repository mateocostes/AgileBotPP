...
def motivoVotos(votos) -> string:
    ...
    motivo_votos_3 = f"En relacion a los diferentes enfoques, {votos[0]} en el optimista, {votos[1]} en el realista y {votos[2]} en el pesimista."
    motivo_votos_4 = f"en mi voto optimista de {votos[0]}, mientras que en el realista he votado {votos[1]} y en el pesimista {votos[2]}."
    motivo_votos_5 = f"asignando {votos[0]} en el voto optimista, {votos[1]} en el realista y {votos[2]} en el pesimista como una representacion equilibrada."
...
def darMotivo(valor_riesgo, valor_optimismo, nombre_partipante, votos, tarea) -> string:
    ...
    if (str(votos[1]) in votos_menores): #0,0.5,1,2,3,5,8
        if (valor_optimismo == 5):
            ...
            motivo_3 = f"Aunque mi nivel de optimismo no es maximo, considero que {motivo}. Por lo tanto, he decidido asignar {motivo_votos}."
            ...
            motivo_1 = f"Me considero una persona muy realista, y {motivo}. Por eso, en la tarea decidi asignar {motivo_votos}."
            ...
            motivo_3 = f"Siendo consciente de la realidad y considerando {motivo}, he asignado {motivo_votos} para reflejar mi enfoque pragmatico."
            ...
            motivo_1 = f"No me considero extremadamente realista, ya que tiendo a ser mas optimista en general. Por eso, en esta tarea he decidido asignar {motivo_votos}."
            ...
            motivo_3 = f"No siendo tan realista, he elegido asignar los votos de la siguiente manera: {motivo_votos}. Esto refleja mi inclinacion hacia el optimismo en lugar del pesimismo."
            ...
            motivo_1 = f"Soy consciente de que tiendo a ser un poco pesimista en mi enfoque. Por eso, en esta tarea he decidido asignar {motivo_votos}, reflejando mi vision mas cautelosa."
            ...
            motivo_3 = f"Mi inclinacion hacia el pesimismo influye en mi decision. Dado que tiendo a ver los aspectos mas negativos, he asignado {motivo_votos}."
            ...
            motivo_1 = f"Me considero una persona extremadamente pesimista y siempre espero lo peor. Por eso, en esta tarea he decidido asignar {motivo_votos}, ya que veo pocas posibilidades de exito."
            ...
            motivo_3 = f"Mi perspectiva pesimista me lleva a creer que {motivo}. Por lo tanto, he decidido asignar {motivo_votos}, reflejando mi vision negativa de la situacion."
        ...
        if (valor_optimismo == 5):
            motivo_1 = f"Aunque mi nivel de optimismo es alto, he considerado los desafios y obstaculos al asignar {motivo_votos}."
            motivo_2 = f"Incluso siendo optimista, he tenido en cuenta los posibles problemas y he votado {motivo_votos}."
            motivo_3 = f"A pesar de mi enfoque optimista, he asignado {motivo_votos} para reflejar una evaluacion equilibrada de la situacion."
            ...
            motivo_1 = f"Incluso siendo moderadamente optimista, he considerado los posibles desafios y he asignado {motivo_votos}."
            ...
            motivo_4 = f"A pesar de no ser extremadamente optimista, he asignado {motivo_votos}, teniendo en cuenta tanto los aspectos positivos como los posibles obstaculos."
            ...
            motivo_4 = f"Siendo alguien con una perspectiva realista pero tambien optimista, he asignado {motivo_votos}, considerando los desafios que podrian presentarse."
            ...
            motivo_1 = f"Incluso no siendo particularmente optimista, he tenido en cuenta los posibles desafios y he asignado {motivo_votos}."
            ...
            motivo_4 = f"A pesar de no ser extremadamente optimista, considerando {motivo}, he asignado {motivo_votos}, tomando en cuenta los posibles desafios."
            motivo_5 = f"{motivo}. Siendo moderadamente optimista, he votado {motivo_votos}, manteniendo una perspectiva mas equilibrada."
        elif(valor_optimismo == 1):
            motivo_1 = f"Siendo consciente de que tiendo a ser un poco pesimista en mi enfoque, he considerado los posibles desafios y he asignado {motivo_votos}."
            ...
            motivo_1 = f"Dado que soy extremadamente pesimista, he evaluado los posibles desafios y he asignado {motivo_votos}."
            ...
            motivo_4 = f"Siendo una persona con un enfoque muy pesimista, he asignado {motivo_votos}, anticipando dificultades y obstaculos."
